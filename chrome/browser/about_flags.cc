...
#include "chrome/browser/unexpire_flags_gen.inc"
    ...
    {"webxr-hands", flag_descriptions::kWebXrHandInput,
     flag_descriptions::kWebXrHandInputDescription, kOsAll,
     FEATURE_VALUE_TYPE(features::kWebXrHandInput)},
    {"webxr-layers", flag_descriptions::kWebXrLayersName,
     flag_descriptions::kWebXrLayersDescription, kOsAll,
     FEATURE_VALUE_TYPE(features::kWebXrLayers)},
